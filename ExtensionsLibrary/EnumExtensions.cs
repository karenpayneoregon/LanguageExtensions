...
{
    /// <summary>
    /// https://gist.github.com/pbdesk/1723650
    /// When code presents itself on the web and works, might as well use it!
    /// Nice library but will not have any documentation in the help file.
    /// </summary>
